...
import { fetchGuideById, updateGuide } from '../../../api/admin/guideService';
...
const EditGuide = () => {
    ...
    const loadGuide = async () => {
      try {
        ...
        if (guide) {
          ...
          setProjects(guide.projects && guide.projects.length > 0 ? guide.projects : ['']);
        }
      } catch (error) {
        toast.error(error.message || 'Failed to fetch guide details');
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Edit Project Guide</h1>
