...
import { fetchAchievementById, updateAchievement } from '../../../api/admin/achievementService';
...
const EditAchievement = () => {
  ...
  useEffect(() => {
    const getAchievement = async () => {
      try {
        const res = await fetchAchievementById(id);
        const data = res.data;
        ...
        setForm({
          title: data.title || '',
          category: data.category || 'Students',
          date: formattedDate,
        ...
        toast.error('Could not load achievement details');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateAchievement(id, submissionData);
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Edit Achievement</h1>
        <p className="text-gray-500 mt-1">Update achievement details</p>
      </div>
