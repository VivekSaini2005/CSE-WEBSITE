...
import { fetchAchievements, deleteAchievement } from '../../../api/admin/achievementService';
    ...
    <div className="p-4">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage and celebrate department milestones</p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className="bg-red-50 text-red-700 p-4 rounded-lg border border-red-100 flex items-center gap-3">
          ...
          {error}
          <button onClick={loadAchievements} className="ml-auto underline font-medium">Retry</button>
        </div>
      ) : (
              ...
              <tbody>
                {achievements.length === 0 ? (
                  ...
                  achievements.map(achievement => (
                    <tr key={achievement._id} className="border-b last:border-0 border-gray-50 hover:bg-gray-50/50 transition-colors">
                      <td className="p-4 font-medium text-gray-800">{achievement.title}</td>
                      <td className="p-4">
                      ...
                      <td className="p-4 text-gray-600">
                        {achievement.date ? new Date(achievement.date).toLocaleDateString(undefined, {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric'
                        }) : 'N/A'}
                      ...
                      <td className="p-4 text-right">
                        <div className="flex justify-end gap-3">
                          <button
                            onClick={() => navigate(`edit/${achievement._id}`)}
