...
import { createFaculty } from '../../../api/admin/facultyService';
...
const AddFaculty = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ name: '', designation: '', department: 'CSE', email: '', specialization: '', image: '' });
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Add New Faculty</h1>
        <p className="text-gray-500 mt-1">Register a new faculty member into the department</p>
      </div>
