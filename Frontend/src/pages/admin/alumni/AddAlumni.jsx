...
import { createAlumni } from '../../../api/admin/alumniService';
...
const AddAlumni = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to add alumni');
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Add New Alumni</h1>
        <p className="text-gray-500 mt-1">Register a new alumni profile</p>
      </div>
